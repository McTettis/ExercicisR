...
#1. Grafica la distribución de los datos "a" i "b" en un scatter plot.
...
#2. Calcula la regresion lineal que hay entre ambos

lm4 <- ___(a ~ b, data = df4)

___(lm4)

#3. Escribe la equación de la recta

# 

#4. ¿Existe correlacion entre ambas variables? ¿Y causalidad?


#5. Repite el grafico assignando el nombre correcto en cada eje
...
#6. ¿Existe causalidad entre ambas variables?
...
#7. Crea un grafico para este nuevo data-set
...
#8. Crea un modelo de regresion lineal y muestralo usando UNA SOLA linea

___(___(___ ~ ___, ___ = ___))


#9. ¿Existe correlacion entre ambas variables?